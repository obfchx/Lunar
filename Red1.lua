...
local Window = redzlib:MakeWindow({
  ...
  SubTitle = "Your Mom Fat",
  SaveFolder = "Dom Dom Vs Keo Con"
})
local Tab1 = Window:MakeTab({"Main"})
local Tab2 = Window:MakeTab({"Sub Farming"})
local Tab3 = Window:MakeTab({"Stats - Player"})
local Tab4 = Window:MakeTab({"Travel"})
local Tab5 = Window:MakeTab({"Race - Sea Event"})
local Tab6 = Window:MakeTab({"Raid - Material"})
local Tab7 = Window:MakeTab({"Status - Job id"})
local Tab8 = Window:MakeTab({"Setting"})
...
Tab1:AddDiscordInvite({
    Name = "Lunar X | Community",
    Logo = "rbxassetid://17358087763",
    Invite = "https://discord.gg/7aR7kNVt4g"
  })

  local Section = Tab1:AddSection("Setting Farm")

  local DropdownSelectWeapon = Tab1:AddDropdown({
    Name = "Select Weapon",
  ...
  task.spawn(
    ...
    local DropdownDelayAttack = Tab1:AddDropdown({
    ...
    local Section = Tab1:AddSection("Farming 🗡️")

    local ToggleLevel = Tab1:AddToggle({"Auto Farm Level",Description = "Tự Động Cày Cấp", false, function(Value)
        _G.AutoLevel = Value
    end})
    spawn(
        function()
    ...
    local ToggleLevel = Tab1:AddToggle({"Bring Mob",Description = "Gôm Quái", true, function(Value)
