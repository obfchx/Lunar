...
if Third_Sea then
    ...
    local TPBost = Tabs.Main:AddToggle("TPBost", {
        Title = "Tp Boat To Zone6",
        Description = "", 
        Default = false })
        TPBost:OnChanged(function(Value)
        _G.Zone6 = Value
    end)
    Options.TPBost:SetValue(false)
            ...
            if _G.Zone6 then
                for i, v in pairs(workspace.Boats:GetChildren()) do
                    if v:FindFirstChild("Owner") and v:FindFirstChild("Owner").Value == plr then
                        ...
                        wait(1.0)
                        BOat(game:GetService("Workspace").Boats.PirateBrigade.VehicleSeat.CFrame * CFrame.new(0, 3, 0))
                    end
                end
            end
        end
                            ...
                            if not game:GetService("Workspace").Boats:FindFirstChild("PirateBasic") then
                                ...
                                elseif game:GetService("Workspace").Boats:FindFirstChild("PirateBrigade") then
                                    if game.Players.LocalPlayer.Character:WaitForChild("Humanoid").Sit == false then
                                        TweenBoat(game:GetService("Workspace").Boats.PirateBrigade.VehicleSeat.CFrame * CFrame.new(0,1,0))
